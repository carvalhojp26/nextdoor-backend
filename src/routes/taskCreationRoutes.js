...
router.get('/neighborhood', sqlInjectionGuard, authenticateToken, taskCreationController.getTaskCreationByNeighborhoodController); //Vizinho poderá ver tarefas criadadas por outros vizinhos
